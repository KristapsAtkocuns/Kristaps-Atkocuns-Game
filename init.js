...
const col = {
  // col.label is the x-coordinate of the centres of the tiles in
...
const x = [
  // x[n] is the x-coordinate of the centre of the tile numbered n in
  //   the above diagram.
  col.c,
  col.d,
  col.c,
...
const row = {
  // row.label is the y-coordinate of the centres of the tiles in
...
const y = [
  // y[n] is the y-coordinate of the centre of the tile numbered n in
  //   the above diagram.
  row.e,
  row.d,
  row.c,
